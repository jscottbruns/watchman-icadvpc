<?php
defined('APPLICATION_PATH') || define('APPLICATION_PATH', '/var/www/html/icad-poll');

set_include_path(
	realpath('/var/www/icad-poll/include') .
	PATH_SEPARATOR .
	get_include_path()
...
$config_result = ini_decrypt('/var/www/icad-poll/include/watchman.ini');
