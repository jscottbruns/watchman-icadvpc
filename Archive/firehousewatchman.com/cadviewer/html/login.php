...
if ( isset($_COOKIE['autologin']) || isset($_POST['login_button_x']) ) {
	...
	$feedback = $login_class->user_login($_COOKIE['autologin'], $_POST['r']);
}
...
<title>WatchmanCAD Login :: Firehouse Watchman CAD Viewer</title>
...
<div style=\"margin-bottom:5px;height:45px;\">
	<div style=\"text-align:center;font-size:8pt;color:#ff0000;display:none;\" id=\"feedback_holder\">$feedback</div>
</div>
<div style=\"width:350px;padding:35px 25px 20px 25px;border:1px solid #8f8f8f;background-color:#efefef;\">
	...
	<div style=\"text-align:left;margin-top:15px;margin-bottom:0px;margin-left:115px;font-weight:bold;\">WatchmanCAD Login</div>
	<div id=\"login_holder\" style=\"margin-top:15px;\"></div>
</div>
</center>";

echo "
<div style=\"color:#000000;font-size:8pt;padding-top:5px;\">WatchmanCAD :: Firehouse Watchman CAD Viewer</div>";
