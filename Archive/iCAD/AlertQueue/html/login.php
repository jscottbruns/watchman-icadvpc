...
<div style=\"width:350px;padding:35px 25px 20px 25px;border:1px solid #8f8f8f;background-color:#efefef;\">
	...
	<div style=\"text-align:left;margin-top:15px;margin-bottom:0px;margin-left:115px;font-weight:bold;\">Watchman iCAD Login</div>
	<div id=\"login_holder\" style=\"margin-top:15px;\"></div>
</div>
</center>";

echo "
<div style=\"color:#000000;font-size:8pt;padding-top:5px;\">iCAD :: Watchman CAD Viewer</div>";
